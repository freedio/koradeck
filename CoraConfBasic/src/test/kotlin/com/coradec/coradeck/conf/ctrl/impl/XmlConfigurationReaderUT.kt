...
internal class XmlConfigurationReaderUT {
    val myConfig = resource(this@XmlConfigurationReaderUT::class, ".xml").location
    ...
    companion object {
        ...
        private fun writeSaneConfig() {
            ...
            CoraConf.xmlMapper.writerWithDefaultPrettyPrinter().writeValue(File("/tmp/Config.xml"), config)
        }
    ...
    @Test fun readSimpleSaneConfig() {
        // given
        val testee = XmlConfigurationReader
        // when
