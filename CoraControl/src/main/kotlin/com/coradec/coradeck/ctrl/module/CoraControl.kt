...
object CoraControl : CoraModule<CoraControlAPI>() {
     ...
     */
    fun createRequestSet(origin: Origin, recipient: Recipient, vararg requests: Request): RequestSet =
            impl.createRequestSet(origin, recipient, *requests)
     ...
     */
    fun createRequestList(origin: Origin, recipient: Recipient, vararg requests: Request): RequestList =
            impl.createRequestList(origin, recipient, *requests)
}
