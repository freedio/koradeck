...
interface CoraControlAPI: CoraModuleAPI {
     ...
     */
    fun createRequestSet(origin: Origin, requests: Sequence<Request>, processor: Agent? = null): RequestSet
     ...
     */
    fun createRequestList(origin: Origin, requests: Sequence<Request>, processor: Agent? = null): RequestList
     ...
     */
    fun createItemSet(origin: Origin, items: Sequence<Information>, processor: Agent? = null): ItemSet
     ...
     * rest is skipped and the list fails; if any request is cancelled, the rest is skipped and the list is cancelled.
     */
    fun createItemList(origin: Origin, items: Sequence<Information>, processor: Agent? = null): ItemList
